                ...
                <div class="portlet blue box">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject bold uppercase">Waiting for Approval</span>
                        </div>
                        <div class="tools"></div>
                    </div>
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%">
                            ...
                            @foreach($waitingLeaveApplications as $application)
                                <?php  $i++;
                                $hr= explode('|', $application->waiting_for);
                                //$hr_chk = $hr[0] == auth()->user()->employee_id ?? $hr[0] : ($hr[1]=== auth()->user()->employee_id ?? $hr[1]);
                                    if($hr[0] == auth()->user()->employee_id){
                                        $hr_chk = $hr[0];
                                    }else{
                                        $hr_chk = $hr[1];
                                    }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('leave-approve/'.$application->id) }}" class="btn btn-circle btn-sm green-meadow pull-left" title="Approve" onclick="return confirm('Are you sure?')"><i class="fa fa-check"></i></a>
