<div class="form-body">
    <div class="form-group hidden">
        <div class="col-md-8">
            {!! Form::text('id', $value = $paidDayEdit->id ?? null, array('id'=>'id', 'class' => 'form-control')) !!}
            @if($errors->has('id'))
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            {!! Form::select('employee_id',$allEmployees,$value = $paidDayEdit->employee_id ?? '', array('id'=>'employee_id', 'class' => 'form-control select2','onchange'=>"getEmployeeBasicInfo(this.value)",'placeholder'=>'Employee Id', 'required'=>"")) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            ?>
            {!! Form::text('payment_date', $value = $payment_date, array('id'=>'payment_date', 'placeholder'=>'yyyy-mm-dd', 'class' => 'form-control date-picker-format','readonly'=>"")) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            if (@$paidDayEdit->year_month != '') {
                $year_month = date('M-Y', strtotime($paidDayEdit->year_month));
            }
            ?>
            {!! Form::text('year_month', $value = $year_month, array('id'=>'year_month', 'placeholder'=>'mm-yyyy', 'class' => 'form-control date-picker-month','readonly'=>"")) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            ?>
            {!! Form::text('default_date', $value = $default_date, array('id'=>'default_date', 'placeholder'=>'yyyy-mm-dd', 'class' => 'form-control date-picker-format','readonly'=>"")) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            ?>
            {!! Form::text('end_date', $value = $end_date, array('id'=>'end_date', 'placeholder'=>'yyyy-mm-dd','onchange'=>"getDayCount()", 'class' => 'form-control date-picker-format','readonly'=>"")) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            @if($errors->has('day_count'))
                <span class="required">{{ $errors->first('day_count') }}</span>
            @endif
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            @if($errors->has('day_paid'))
                <span
                        class="required">{{ $errors->first('day_paid') }}</span>
            @endif
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            @if($errors->has('ready_to_pay'))
                <span class="required">{{ $errors->first('ready_to_pay') }}</span>
            @endif
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-4 control-label">Employee Status<span class="required">*</span></label>
        <div class="col-md-8">
            {!! Form::select('emp_status', $empStatus, $value = $paidDayEdit->emp_status ?? '', array('id'=>'emp_status', 'class' => 'form-control', 'required'=>"")) !!}
            @if($errors->has('emp_status'))
                <span class="required">{{ $errors->first('emp_status') }}</span>
            @endif
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            @if($errors->has('remarks'))
                <span
                        class="required">{{ $errors->first('remarks') }}</span>
            @endif
        </div>
    </div>
