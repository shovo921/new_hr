<div class="form-body">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            @if($errors->has('acc_no'))
                <span
                        class="required">{{ $errors->first('account_no') }}</span>
            @endif
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            {!! Form::text('disb_date', $value = null, array('id'=>'disb_date', 'placeholder'=>'dd/mm/yyyy', 'class' => 'form-control date-picker')) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            {!! Form::text('start_month', $value = null, array('id'=>'start_date', 'placeholder'=>'dd/mm/yyyy', 'class' => 'form-control date-picker-month')) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            {!! Form::text('end_month', $value = null, array('id'=>'end_date', 'placeholder'=>'dd/mm/yyyy', 'class' => 'form-control date-picker1')) !!}
        </div>
    </div>
