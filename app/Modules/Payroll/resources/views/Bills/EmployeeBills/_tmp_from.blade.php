<div class="form-body">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            {!! Form::text('bill_type', $value = 'Mobile Bill', array('id'=>'bill_type','placeholder'=>'Please Select Bill Type','readonly'=>'readonly', 'class' => 'form-control', 'required'=>"")) !!}
    ...
    <div class="form-group">
        <label class="col-md-4 control-label">Bill Amount<span class="required">*</span></label>
        <div class="col-md-8">
            {!! Form::text('remarks', $value = $data['employeeBills']->remarks ?? null, array('id'=>'remarks','placeholder'=>'Remarks', 'class' => 'form-control', 'required'=>"")) !!}
    ...
    <div class="form-group">
        <div class="col-md-offset-4 col-md-8">
            ...
            @endif
                <a href="{{  route('emp-bills.tmp') }}" class="btn btn-success">Back</a>
        </div>
