...
//    	$holidays = Holiday::all();
        ...
        $bonus=FestivalBonus::get();
        return view("FestivalBonus::index", compact('bonus'));
    }
    ...
    {
        $bonus = FestivalBonus::findOrFail($id);
        $bonus->payment_date = date('Y-m-d', strtotime($bonus->payment_date));
        return view('FestivalBonus::edit',compact('bonus'));
    }
