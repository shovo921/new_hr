            ...
            <div class="table-responsive">
                ...
                <div class="portlet blue box">
                    <div class="portlet-title">
                        ...
                        <a href="{{  route('BrBom.createOrEdit',0) }}" class="btn btn-default pull-right"
                        ...
                        <div class="caption">
                            ...
                            <span class="caption-subject bold uppercase">BOM List</span>
                        </div>
                        <div class="tools"></div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%"
                            ...
                            @foreach($data['Br_Bom_List'] as $singleData)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('BrBom.createOrEdit',$singleData->id) }}"
