...
<div class="row">
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-gift"></i>Employee Promotion Information</div>
				<div class="tools">
		...
		<div class="portlet-body form">
			<div class="col-md-8">
				{!! Form::open(array('url' => 'employeePromotionStore', 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal')) !!}
					...
					{!! Form::hidden('previous_des_id', $value = @$EmployeeDetailsInfo->designation_id, array('id'=>'previous_des_id', 'class' => 'form-control', 'required'=>"")) !!}


				<div class="form-group">
					<label class="col-md-4 control-label">Employee Designation<span class="required">*</span></label>
					<div class="col-md-8">
						{!! Form::select('promoted_des_id', $designations, $value = @$EmployeeDetailsInfo->designation_id, array('id'=>'promoted_des_id', 'class' => 'form-control', 'required'=>"", 'onchange'=>'calculatePromotionBasic(this.value, '.@$EmployeeDetailsInfo->designation_id.', '.@$employeeSalaryData->current_inc_slave.')')) !!}

						@if($errors->has('promoted_des_id'))<span class="required">{{ $errors->first('promoted_des_id') }}</span>@endif
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						{!! Form::select('current_inc_slave', $incrementSlave, $value = @$employeeSalaryData->current_inc_slave, array('id'=>'current_inc_slave', 'class' => 'form-control', 'required'=>"", 'onchange'=>'calculatePromotionBasicWith(this.value)')) !!}
