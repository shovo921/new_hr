...
@section('breadcrumb')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ url('/all-sal') }}">Branch/Division Head List</a>
            </li>
        </ul>
            ...
            <div class="table-responsive">
                ...
                <div class="portlet blue box">
                    <div class="portlet-title">
                        <a href="{{  url('createBrdivhead') }}" class="btn btn-default pull-right" style="margin-top: 3px;">
                            <i class="fa fa-plus"></i>
                            Add New Division Head
                        </a>
                        <div class="caption">
                            <i class="icon-settings"></i>
                            <span class="caption-subject bold uppercase">Branch/Division Head List</span>
                        </div>
                        <div class="tools"></div>
                    </div>
                    ...
                    <div class="form-group">
                            {{Form::open(['url'=>'brdivhead','method'=>'get'])}}
                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                <label for="FromDate" class="control-label">Employee:</label>
                        ...
                        {{--<table class="table table-striped table-bordered table-hover dt-responsive" width="100%">--}}
                         <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_5">
                            ...
                            @foreach($brDivHeadList as $application)
                                <?php $i++; ?>
                                ...
                                <tr>
                                    ...
                                    <td>{{ @$application->postdBranch->branch_name ??  '' }}</td>
                                    <td>{{ @$application->division->br_name.$application->branch_id ??  '' }}</td>
                                    ...
                                    <td>{!! ((int)$application->status == 2) ? '<font color="red">No</font>':'<font color="green">Yes</font>'!!}</td>

                                    <td>
                                        <a href="{{ url('editPosting/'.$application->branch_id.'') }}" class="btn btn-circle btn green btn-sm purple pull-left"><i class="fa fa-edit"></i>Edit</a>
                       ...
                       @if($brDivHeadList->count()>0)
                            {{$brDivHeadList->appends($_REQUEST)->render()}}
                        @endif
                    </div>
                </div>
