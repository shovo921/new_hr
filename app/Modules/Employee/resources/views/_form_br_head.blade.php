...
<div class="form-body">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            {!! Form::text('branch_name', $value = @$branchInfo->branch_name, array('id'=>'branch_name','readonly'=>'readonly','placeholder'=>'Branch/Division', 'class' => 'form-control')) !!}
            @if($errors->has('branch_name'))<span
                    class="required">{{ $errors->first('branch_name') }}</span>@endif
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            {!! Form::select('status', $head, $value =@$divOrBrHead->status, array('id'=>'status', 'class' => 'form-control', 'required'=>"")) !!}
