					...
					<table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_5">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="javascript:;" onclick="authorizeViewModal('{{ $incrementHistory->employee_id}},{{$incrementHistory->inc_slave_no}}')" class="btn btn-circle btn green btn-sm purple pull-left">
									...
									<a href="{{ url('cancelIncrement/'.$incrementHistory->employee_id.'') }}" class="btn btn-circle btn green btn-sm red pull-left" onclick="return confirm('Are you sure?')">
