...
<div class="row">
    ...
    <div class="col-md-8 col-md-offset-1">
        ...
        {!! Form::open(array('url' => 'storeEmployeeTransfer', 'method' => 'post','enctype'=>'multipart/form-data', 'role' => 'form', 'class' => 'form-horizontal')) !!}
    ...
    @else
        <div class="col-md-8 col-md-offset-1">
            {!! Form::model($empPostingInfo, array('url' => 'posting-edit/'.$empPostingInfo->id, 'method' => 'PUT', 'role' => 'form','enctype'=>'multipart/form-data', 'class' => 'form-horizontal')) !!}
